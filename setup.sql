...
IF OBJECT_ID('RefundRequests', 'U') IS NOT NULL DROP TABLE RefundRequests;
...
-- ====== Sample Data: Users ======
INSERT INTO Users
    (username, password, role, name, gender, dateOfBirth, phone, email, isVerified)
VALUES
...
INSERT INTO Products
    (name, price, description, stock, importDate, category, supplierId)
VALUES
...
VALUES
    (2, 2047000, N'Completed', '2026-03-01'),
    -- order 1: user1
    (2, 565000, N'Shipped', '2026-03-05'),
    -- order 2: user1
    (3, 6187000, N'Pending', '2026-03-08'),
    -- order 3: user2
...
CREATE OR ALTER VIEW vw_DailyIncome
AS
    SELECT
...
-- ====== Migration: Add i18n fields to Products table ======
-- Run this block if you already have the database and want to add multilingual support.
/*
...
-- Optional: Update existing products with English names
UPDATE Products SET 
    name_en = name,
