...
<head>
    ...
    <style>
        ...
        .info-box { border: 1px solid #ccc; border-radius: 4px;
                    padding: 14px; max-width: 520px; margin-bottom: 20px; background: #fafafa; }
        .info-box p { margin: 5px 0; }
        .form-group { margin-bottom: 16px; max-width: 520px; }
        ...
        .btn-submit { background: #c62828; color: white; border-color: #c62828; }
...
<h1>Request Refund for Order #<%= order.getId() %></h1>
<nav>
