...
<head>
    ...
    %>
    <title><%= isEdit ? "Edit User" : "Add User" %> - Admin</title>
    <style>
        ...
        input[type="date"], input[type="tel"], select { padding: 6px; width: 300px;
...
<body>
<nav>
    <a href="${pageContext.request.contextPath}/admin/users">&larr; Back to User List</a>
</nav>
