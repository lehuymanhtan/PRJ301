        ...
        <body>
            <% User currentUser=(User) session.getAttribute("user"); List<User> users = (List<User>)
                    ...
                    <% if ("created".equals(success)) { %>
                        <p class="msg-success">User created successfully.</p>
                        <% } %>
                            <% if ("updated".equals(success)) { %>
                                <p class="msg-success">User updated successfully.</p>
                                <% } %>
                                    <% if ("deleted".equals(success)) { %>
                                        <p class="msg-success">User deleted successfully.</p>
                                        <% } %>
                                            <% if ("notfound".equals(errParam)) { %>
                                                <p class="msg-error">User not found.</p>
                                                <% } %>
                                                        ...
                                                        <% } %>
                                                            ...
                                                            <form class="search-form" method="get"
                                                                ...
                                                                <% if (kw !=null && !kw.isEmpty()) { %>
                                                                    <a
                                                                        href="${pageContext.request.contextPath}/admin/users">Clear</a>
                                                                    <% } %>
                                                            </form>
