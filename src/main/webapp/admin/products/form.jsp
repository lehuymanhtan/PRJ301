...
<body>
<nav>
    <a href="${pageContext.request.contextPath}/admin/products">&larr; Back to Product List</a>
</nav>
...
<form method="post" action="${pageContext.request.contextPath}/admin/products">
    ...
    <div class="form-group">
        ...
        <textarea id="description" name="description"><%= isEdit && editProduct.getDescription() != null ? editProduct.getDescription() : "" %></textarea>
    </div>
